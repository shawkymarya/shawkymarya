...
![Seaborn](https://img.shields.io/badge/Seaborn-268bd2?style=flat&logo=python&logoColor=white)
...
class ShawkyMohamed:
    def __init__(self):
        self.name = "Shawky Mohamed"
        self.role = "AI & Data Science Developer"
        self.skills = ["Machine Learning", "Deep Learning", "Data Analysis", "Visualization"]
